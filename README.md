...
> (e)bug appeared in vector cart_items,cart_quantity and cart price where program ends if the user has less array length than stock quantity(fixed this).
> (f)fixed the bug in admin menu where exit terminates the program.
